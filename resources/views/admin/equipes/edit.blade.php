            ...
            <form method="POST" action="{{ route('admin.equipes.update', [$equipe->id]) }}" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('nom') ? 'is-invalid' : '' }}" type="text" name="nom"
                        id="nom" value="{{ old('nom', $equipe->nom) }}" required>
                    @if ($errors->has('nom'))
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('nom_coach') ? 'is-invalid' : '' }}" type="text"
                        name="nom_coach" id="nom_coach" value="{{ old('nom_coach', $equipe->nom_coach) }}" required>
