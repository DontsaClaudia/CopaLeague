                                ...
                                <td>
                                    @can('joueur_show')
                                        <a class="btn btn-xs btn-primary"
                                            href="{{ route('admin.joueurs.show', $joueur->id) }}">
                                            {{ trans('global.view') }}
                                        </a>
                                    @endcan
                                    ...
                                    @can('joueur_delete')
                                        <form action="{{ route('admin.joueurs.destroy', $joueur->id) }}" method="POST"
...
@section('scripts')
    ...
    <script>
        $(function() {
            ...
            let table = $('.datatable-Joueur:not(.ajaxTable)').DataTable({
                buttons: dtButtons
            })
