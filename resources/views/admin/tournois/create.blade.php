    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.tournois.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('nom_tournois') ? 'is-invalid' : '' }}" type="text" name="nom_tournois" id="nom_tournois" value="{{ old('nom_tournois', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('nombre_d_equipes') ? 'is-invalid' : '' }}" type="number" name="nombre_d_equipes" id="nombre_d_equipes" value="{{ old('nombre_d_equipes', '') }}" step="1" required>
